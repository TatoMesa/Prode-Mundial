...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-r8wjau&l&n7-y+flo&08ee((t-r7wt8&n*167lfpu2ktq^7213')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.accounts.context_processors.user_points',
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'matches:list'
LOGOUT_REDIRECT_URL = 'matches:list'

# Predictions lock time (minutes before match start)
